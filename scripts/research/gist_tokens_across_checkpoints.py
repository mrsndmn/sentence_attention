...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_gist_embeddings_path", type=str, default="/tmp/gist_embeddings_per_checkpoints.png")
    ...
    model_checkpoints.extend(
        glob.glob(
            "artifacts/experiments/eos_4/sentence_Llama-3.2-3B_ft_only_eos_embedding_num_eos_tokens_4_5TEI8QWR/checkpoint-*"
        )
    )
    model_checkpoints.extend(
        glob.glob("artifacts/experiments/eos_4/sentence_Llama-3.2-3B_ft_4k_full_num_eos_tokens_4_KS38WK9A/checkpoint-*")
    )
    model_checkpoints.extend(
        glob.glob(
            "artifacts/experiments/eos_4/sentence_Llama-3.2-3B_ft_4k_colddown_full_num_eos_tokens_4_M10GPB8E/checkpoint-*"
        )
    )
